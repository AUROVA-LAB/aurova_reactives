...
#ifndef _reactive_velodyne_alg_h_
#define _reactive_velodyne_alg_h_

#include <reactive_velodyne/ReactiveVelodyneConfig.h>
#include <pcl/point_cloud.h>
#include <sensor_msgs/PointCloud2.h>

//include reactive_velodyne_alg main library
 ...
 *
 */
class ReactiveVelodyneAlgorithm
{
protected:
  /**
   * \brief define config type
   *
   * Define a Config type with the ReactiveVelodyneConfig. All driver implementations
...
public:
   ...
   * will then use the same variable type Config.
   */
  typedef reactive_velodyne::ReactiveVelodyneConfig Config;
  ...
  // here define all reactive_velodyne_alg interface methods to retrieve and set
